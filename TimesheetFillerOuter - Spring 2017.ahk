...
FullWeek() {
    ...
    loop, 2 {
        ...
        Send, 3:30              ; Monday/Wednesday Clock In
        ...
        Send, 12:30             ; Tuesday/Thursday Clock In
        Send, {tab}{down}{tab}  ; PM
        Send, 5:30              ; Tuesday/Thursday Clock Out
        Send, {tab}{down}       ; PM
        loop, 23 {              ; Scroll to Next Day button
            Send, {tab}
        }
    ...
    Send, 9:00              ; Friday Clock In
    Send, {tab}{tab}        ; AM
    Send, 5:00              ; Fiday Clock Out
    Send, {tab}{down}       ; PM
    loop, 23 {              ; Scroll to Next Day button
        Send, {tab}
    }
