...
FullWeek() {
    ...
    loop, 2 {
        ...
        Send, 8:00              ; Monday/Wednesday Clock In
        Send, {tab}{tab}        ; AM 
        Send, 12:00             ; Monday/Wednesday Clock Out
        Send, {tab}{down}{tab}  ; PM
        Send, {tab}1:00         ; Monday/Wednesday Clock In
        Send, {tab}{down}{tab}  ; AM 
        Send, 5:00              ; Monday/Wednesday Clock Out
        Send, {tab}{down}       ; PM
